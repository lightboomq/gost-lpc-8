  ...
  const [todo] = React.useState([
                  {title:"Гост 503-81",
                   text:<div id='gost-503' className='div-503-81'>
                    ...
                    <img id='gost-503-1' className="gost-503-81" src="/img/503-81-3.png" alt="3"/>
                    </div>},
                  {title:"Гост ТУ 14-4-1207-82",
                   text:<div>
                      <p>
                        ...
                        <p>
                        1. Предельные отклонения по толщине и ширине  должны соответствовать требованиям <a onClick={clearSearchValue} href="#gost-503">ГОСТ 503-81</a> для нормальной и повышенной (Т и Ш) точности изготовления. По требованию потребителя лента может изготовляться высокой точности по толщине (В). Класс точности указывается в заказе. 
                        </p>                                            
                        <p>2. По виду и качеству поверхности лента должна соответствовать 1,2 или 3 группе отделки поверхности по <a onClick={clearSearchValue} href='#gost-503'>ГОСТ 503–81</a> группа отделки поверхности оговаривается в заказе.</p>
                        <p>3. <span>Серповидность</span> ленты должна соответствовать классу А или Б по <a onClick={clearSearchValue} href='#gost-503-1'>ГОСТ 503–81</a> Класс ленты оговаривается в заказе.</p>
                     </div>
                    },

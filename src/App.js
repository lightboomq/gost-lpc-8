  ...
  const [todo] = React.useState([
                    ...
                    </div>},
                  {
                    ...
                    },
                    {
                      ...
                      text:<div>
                        <p>
                        Настоящие технические условия распространяются на прокат рулонный горячекатаный травленый из нелегированной стали марки 07ГБЮ и 07 ГБЮ «селект»  предназначенную для холодной штамповки   деталей автомобилей АВТОВАЗ.
                        </p>
                        <img className="img-gost-all" src="/img/5262-2008.png"/>
                        <p>
                        Состояние поверхности и кромок проката должно соответствовать требованиям <a onClick={clearSearch}  href=''>ГОСТ 16523</a> для ленты толщиной до 3,9 мм и <a onClick={clearSearch}    href=''>ГОСТ 4041</a> (Нет госта в выписках) для ленты толщиной 4,0 мм и более. <br/> Для проката толщиной 4,5 мм кромки обрезанные под прямым углом, не должны иметь трещин, рванин, зазубрин.<br/>
                        На обеих сторонах проката,  предназначенного для штамповки дисков колес, не допускаются дефекты глубиной более 0,05 мм. 
                        </p>
                      </div>  
                    },
                    {
                    ...
                    },
                    {
                      ...
                      text:<div>
                        ...
                        <img className="img-gost-all" src="/img/2284-79.png" alt=""/>
                        <p>
                        ...
                        <img className="img-gost-all" src="/img/2284-79-1.png" alt=""/>
                      </div>
                    },
                    {
